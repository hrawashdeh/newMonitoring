package com.tiqmo.monitoring.importexport.filter;
 ...
 *   <li>requestId - Unique request ID for this service instance</li>
 *   <li>contextId - Business context identifier (environment/tenant)</li>
 *   <li>processId - JVM process ID</li>
 *   <li>serviceId - Service identifier ("imex" for import-export service)</li>
...
public class CorrelationIdFilter extends OncePerRequestFilter {
    ...
    private static final String SERVICE_ID = "imex";
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            // Generate unique request ID for this service instance
            ...
            log.debug("MDC context initialized: correlationId={}, requestId={}, serviceId={}, path={}, clientIp={}",
                    correlationId, requestId, SERVICE_ID, request.getRequestURI(), extractClientIp(request));
