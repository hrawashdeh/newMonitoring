...
> **MASTER DOCUMENT** - Single source of truth for cross-session development tracking and handovers.

**Last Updated:** 2025-12-26 (Updated: Documentation reorganized, Design System added)
...
- **[PROJECT_TRACKER.md](./PROJECT_TRACKER.md)** (THIS FILE) - Master document, development tracking
- **[KNOWN_ISSUES.md](./KNOWN_ISSUES.md)** - All tracked issues with strategic context
- **[POC_CHECKLIST.md](./POC_CHECKLIST.md)** - Day-by-day POC implementation tasks

### Design Documents (`/docs/design/`)
- **[DESIGN_SYSTEM.md](../design/DESIGN_SYSTEM.md)** - Complete UX/UI design system (NEW)
  - Design tokens (customizable: logo, fonts, colors, spacing)
  - Typography system
  - Color system
  - Component library
...
- **[LOADER_FUNCTIONALITY_TREE.md](../design/LOADER_FUNCTIONALITY_TREE.md)** - Complete feature inventory
  - 70+ features across 7 major areas
  - Navigation structure (3-tier design)
  - User role access matrix (RBAC)
  - Implementation priority (4 phases)
  - Drill-down patterns

- **[UI_WIREFRAMES_AND_MOCKUPS.md](../design/UI_WIREFRAMES_AND_MOCKUPS.md)** - Complete UI specifications
  - Technology stack with justifications
  - Detailed wireframes for all pages
  - Component library specifications
  - HATEOAS implementation (backend + frontend)
  - Responsive design patterns
  - Accessibility guidelines

### Implementation Documents (`/docs/implementation/`)
- **[LOADER_IMPLEMENTATION_GUIDE.md](../implementation/LOADER_IMPLEMENTATION_GUIDE.md)** - Focused implementation guide
  - Loader functions inventory (10 core functions)
  - Loader screens and wireframes (4 screens)
  - Database schema (loader-specific)
  - API requirements (13 endpoints)
...
- **[TOMORROW_TASK_PROMPT.md](../implementation/TOMORROW_TASK_PROMPT.md)** - Day 1 session prompt
...
- **[AUTH_SERVICE_SUMMARY.md](../technical/AUTH_SERVICE_SUMMARY.md)** - Authentication service design
- **[AUTHENTICATION_CLEANUP_SUMMARY.md](../technical/AUTHENTICATION_CLEANUP_SUMMARY.md)** - Auth cleanup status
- **[AUTH_DEPLOYMENT_VERIFICATION.md](../technical/AUTH_DEPLOYMENT_VERIFICATION.md)** - Deployment verification
- **[FINAL_AUTH_STATUS.md](../technical/FINAL_AUTH_STATUS.md)** - Final auth implementation status
- **[GATEWAY_DEPLOYMENT_TASK.md](../technical/GATEWAY_DEPLOYMENT_TASK.md)** - Gateway deployment guide
